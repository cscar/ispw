...
public class BoundaryPanelChangeProfileLandLordEnglish extends BoundaryPanelChangeProfileLandLord {
	private static final long serialVersionUID = 1L;
	private JDialog dialog;

	public BoundaryPanelChangeProfileLandLordEnglish(JDialog dialog) {
		super(dialog);
		this.dialog=dialog;
