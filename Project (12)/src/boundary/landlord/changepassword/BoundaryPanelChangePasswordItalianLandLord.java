...
public class BoundaryPanelChangePasswordItalianLandLord extends BoundaryPanelChangePasswordLandLord{
	private static final long serialVersionUID = 1L;
	private JDialog dialog;

	public BoundaryPanelChangePasswordItalianLandLord(JDialog dialog) {
		super(dialog);
		this.dialog=dialog;
