...
import control.changepassword.ChangePasswordLandLord;
...
public abstract class BoundaryPanelChangePasswordLandLord extends JPanel{
	...
	public BoundaryPanelChangePasswordLandLord(JDialog dialog) {
    ...
    private class ButtonConfirmListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				ChangePasswordLandLord.change(getPassword(), getPasswordConfirm());
