...
public class BoundaryPanelChangePasswordTenantEnglish extends BoundaryPanelChangePasswordTenant {
	private static final long serialVersionUID = 1L;
	private JDialog dialog;

	public BoundaryPanelChangePasswordTenantEnglish(JDialog dialog) {
		super(dialog);
		this.dialog = dialog;
	...
	protected void successfulRegistrationMessage() {
		JOptionPane.showMessageDialog(dialog, 
				...
				StringsEnglish.STR_CHANGE_PASSWORD,
