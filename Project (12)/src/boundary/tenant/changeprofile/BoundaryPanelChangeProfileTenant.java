...
import control.changeprofile.ChangeProfileTenant;
...
public abstract class BoundaryPanelChangeProfileTenant extends JPanel{
	...
	public BoundaryPanelChangeProfileTenant(JDialog dialog) {
    ...
    private class ButtonConfirmListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				ChangeProfileTenant.changeProfile(getPhone(), getTaxCode(), 
						getAddress(), getFax(), getWebSite(), 
						getQuestion(), getSecurityAnswers());
