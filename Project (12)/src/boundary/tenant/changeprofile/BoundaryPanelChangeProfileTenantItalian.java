...
public class BoundaryPanelChangeProfileTenantItalian extends BoundaryPanelChangeProfileTenant {
	private static final long serialVersionUID = 1L;
	private JDialog dialog;

	public BoundaryPanelChangeProfileTenantItalian(JDialog dialog) {
		super(dialog);
		this.dialog = dialog;
