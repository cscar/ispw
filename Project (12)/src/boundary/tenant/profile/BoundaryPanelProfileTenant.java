...
import boundary.tenant.changepassword.BoundaryChangePasswordTenantDialog;
import boundary.tenant.changeprofile.BoundaryChangeProfileTenantDialog;
import entity.SingletonFrame;
import entity.Styles;

public abstract class BoundaryPanelProfileTenant extends JPanel {
	...
	public BoundaryPanelProfileTenant(JDialog dialog) {
	...
	private class ButtonModifyProfileListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			BoundaryChangeProfileTenantDialog modifyProfileDialog = new BoundaryChangeProfileTenantDialog(
	...
	private class ButtonModifyPasswordListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			BoundaryChangePasswordTenantDialog modifyPasswordDialog = new BoundaryChangePasswordTenantDialog(
					SingletonFrame.getFrameInstance().getFrame());
