...
public class BoundaryPanelSearchPropertyEnglish extends BoundaryPanelSearchProperty {
	private static final long serialVersionUID = 1L;

	public BoundaryPanelSearchPropertyEnglish(JDialog dialog, Property property) {
	...
	protected void fileWriteErrorMessage() {
		JOptionPane.showMessageDialog(dialog,
				StringsEnglish.FILE_WRITE_ERROR,
