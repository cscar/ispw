...
import boundary.rent.BoundaryRentDialog;
...
public abstract class BoundaryPanelSearchProperty extends JPanel {
	...
	public BoundaryPanelSearchProperty(JDialog dialog, Property property) {
		...
		panelButtons.add(btnRent);
		panelButtons.add(btnCancel);

		// ESC key listener
		this.dialog.getRootPane().registerKeyboardAction(new EscapeKeyListener(),
	...
	private class ButtonRentListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			BoundaryRentDialog rentDialog = new BoundaryRentDialog(dialog, property);
