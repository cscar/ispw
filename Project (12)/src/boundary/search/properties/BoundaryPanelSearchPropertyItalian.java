...
public class BoundaryPanelSearchPropertyItalian extends BoundaryPanelSearchProperty {
	private static final long serialVersionUID = 1L;

	public BoundaryPanelSearchPropertyItalian(JDialog dialog, Property property) {
	...
	protected void fileWriteErrorMessage() {
		JOptionPane.showMessageDialog(dialog,
				StringsItalian.FILE_WRITE_ERROR,
