...
public class BoundaryPanelSearchEnglish extends BoundaryPanelSearch {
	...
	public BoundaryPanelSearchEnglish(Window window, ArrayList<Property> properties) {
	...
	protected void addProperty(Property property) {
		...
		// View button
		btnView = new JButton(StringsEnglish.STR_BTN_VIEW);
		...
		lblPropertyType = new JLabel(StringsEnglish.STR_PROP);
		constraints.gridx = 0;
		constraints.gridy = 0;
		...
		lblUniversity = new JLabel(StringsEnglish.STR_UNIV_FAC);
		constraints.gridx = 0;
		constraints.gridy = 1;
		...
		lblMunicipality = new JLabel(StringsEnglish.STR_MUNIC);
		constraints.gridx = 0;
		constraints.gridy = 2;
		...
		lblMq = new JLabel(StringsEnglish.STR_MQ);
		constraints.gridx = 0;
		constraints.gridy = 3;
		...
		lblMonthlyFee = new JLabel(StringsEnglish.STR_MAX);
		constraints.gridx = 0;
		constraints.gridy = 4;
		...
		case Constants.ROOM_STUDENTS:
			tfPropertyType.setText(StringsEnglish.STR_STUD_ROOM);
			tfMonthlyFee.setText(String.valueOf(((RoomStudents) property).getRoomPrice()));
			break;
		case Constants.HOUSE_STUDENTS:
			tfPropertyType.setText(StringsEnglish.STR_STUD_H);
	...
	private class ButtonViewListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			BoundarySearchPropertyDialog dialog = new BoundarySearchPropertyDialog(
					BoundaryPanelSearchEnglish.this.window, property);
	...
	protected void fileReadErrorMessage() {
		JOptionPane.showMessageDialog(window, StringsEnglish.STR_FILE_READ_ERROR, StringsEnglish.STR_ERROR,
