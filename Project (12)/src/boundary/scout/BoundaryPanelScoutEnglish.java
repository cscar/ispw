...
public class BoundaryPanelScoutEnglish extends BoundaryPanelScout {
	...
	public BoundaryPanelScoutEnglish(JDialog dialog) {
		super(dialog);
		dialog.setTitle(StringsEnglish.STR_WELCOME_SCOUT);
	}
	...
	protected void addProperty(Property property) {
		...
		// Evaluate button
		btnEvaluate = new JButton(StringsEnglish.STR_BTN_EVALUATE);
	...
	private class ButtonEvaluateListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			BoundaryPropertyDialog propertyDialog = new BoundaryPropertyDialog(BoundaryPanelScoutEnglish.this.dialog,
					property);
