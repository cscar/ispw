...
public class RegistrationHouse {

	public static void registrationHouse(Customer customer, String nickName, String municipality, String province,
		...
		if (nickName.equals("") || municipality.equals("") || province.equals("") || address.equals("")
			...
			HouseStudents house = new HouseStudents(customer, nickName, municipality, province, address, houseNumber,
					mq, university, wc, specialGuest, parkingSpace, specialGuestPrice, bestAppliances, expenses, bus,
					otherStudents, wifi, animals, garden, contractTerm2, contractTerm1, singleRoomWC, doubleRoomWC,
					singleRoom, doubleRoom, singleRoomWCPrice, doubleRoomWCPrice, singleRoomPrice, doubleRoomPrice);
			SaveProperties.getInstance().insertProperties(house);
/*
			LandLord landlord = (LandLord) Session.getSessionInstance().getCustomer();
			Save.getInstance().deleteUser(landlord.getEmail());
			landlord.addProperty(house);
