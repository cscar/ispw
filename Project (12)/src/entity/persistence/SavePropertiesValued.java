...
public class SavePropertiesValued {

	private static SavePropertiesValued instance = null;
	private String fileName;
	private String tmpFileName;

	private SavePropertiesValued(String fileName, String tmpFileName) {
	...
	public static synchronized final SavePropertiesValued getInstance() {
		if (SavePropertiesValued.instance == null) {
			SavePropertiesValued.instance = new SavePropertiesValued(Filepaths.PROPERTIES_RENT_DATABASE_FILENAME,
					Filepaths.PROPERTIES_RENT_DATABASE_TMP);
		}
		return instance;
	}
